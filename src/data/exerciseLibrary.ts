...
export type ExerciseEquipmentTag =
  | 'dumbbell'
  | 'barbell'
  | 'smith'
  | 'cable'
...
export const EXERCISE_EQUIPMENT_TAGS: Record<string, ExerciseEquipmentTag[]> = {
  ...
  'barbell-row': ['barbell'],
  't-bar-row': ['barbell', 'plate-loaded'],
  ...
  'leg-press-calf-raise': ['machine', 'plate-loaded'],
  'shoulder-press': ['dumbbell'],
  'machine-shoulder-press': ['machine'],
  'smith-shoulder-press': ['smith', 'machine'],
  'landmine-press': ['barbell', 'plate-loaded'],
...
export const EXERCISE_EQUIVALENCE_CHAINS: Record<string, ExerciseEquivalenceChain> = {
  ...
  'incline-db-press': chain('incline-press', '上斜推链', '胸', '上斜推', ['incline-db-press', 'smith-incline-press', 'machine-incline-chest-press']),
  'smith-incline-press': chain('incline-press', '上斜推链', '胸', '上斜推', ['incline-db-press', 'smith-incline-press', 'machine-incline-chest-press']),
  'machine-incline-chest-press': chain('incline-press', '上斜推链', '胸', '上斜推', ['incline-db-press', 'smith-incline-press', 'machine-incline-chest-press']),
  'cable-fly': chain('fly', '飞鸟链', '胸', '飞鸟', ['cable-fly', 'pec-deck-fly', 'db-fly']),
  'pec-deck-fly': chain('fly', '飞鸟链', '胸', '飞鸟', ['cable-fly', 'pec-deck-fly', 'db-fly']),
  'db-fly': chain('fly', '飞鸟链', '胸', '飞鸟', ['cable-fly', 'pec-deck-fly', 'db-fly']),
  ...
  'face-pull': chain('rear-delt', '后束肩胛控制链', '肩', '肩胛控制', ['face-pull', 'reverse-pec-deck', 'cable-rear-delt-fly', 'rear-delt-raise']),
  'reverse-pec-deck': chain('rear-delt', '后束肩胛控制链', '肩', '后束飞鸟', ['face-pull', 'reverse-pec-deck', 'cable-rear-delt-fly', 'rear-delt-raise']),
  'cable-rear-delt-fly': chain('rear-delt', '后束肩胛控制链', '肩', '后束飞鸟', ['face-pull', 'reverse-pec-deck', 'cable-rear-delt-fly', 'rear-delt-raise']),
  'rear-delt-raise': chain('rear-delt', '后束肩胛控制链', '肩', '后束飞鸟', ['face-pull', 'reverse-pec-deck', 'cable-rear-delt-fly', 'rear-delt-raise']),
  'shoulder-press': chain('vertical-press', '垂直推链', '肩', '垂直推', ['shoulder-press', 'machine-shoulder-press', 'smith-shoulder-press', 'landmine-press']),
  'machine-shoulder-press': chain('vertical-press', '垂直推链', '肩', '垂直推', ['shoulder-press', 'machine-shoulder-press', 'smith-shoulder-press', 'landmine-press']),
  'smith-shoulder-press': chain('vertical-press', '垂直推链', '肩', '垂直推', ['shoulder-press', 'machine-shoulder-press', 'smith-shoulder-press', 'landmine-press']),
  'landmine-press': chain('vertical-press', '垂直推链', '肩', '斜向推', ['shoulder-press', 'machine-shoulder-press', 'smith-shoulder-press', 'landmine-press']),
  'lateral-raise': chain('lateral-raise', '侧平举链', '肩', '肩外展', ['lateral-raise', 'cable-lateral-raise', 'machine-lateral-raise']),
  'cable-lateral-raise': chain('lateral-raise', '侧平举链', '肩', '肩外展', ['lateral-raise', 'cable-lateral-raise', 'machine-lateral-raise']),
  'machine-lateral-raise': chain('lateral-raise', '侧平举链', '肩', '肩外展', ['lateral-raise', 'cable-lateral-raise', 'machine-lateral-raise']),
  'db-curl': chain('biceps-curl', '二头弯举链', '手臂', '肘屈', ['db-curl', 'ez-bar-curl', 'preacher-curl', 'cable-curl', 'incline-db-curl']),
  'ez-bar-curl': chain('biceps-curl', '二头弯举链', '手臂', '肘屈', ['db-curl', 'ez-bar-curl', 'preacher-curl', 'cable-curl', 'incline-db-curl']),
  'preacher-curl': chain('biceps-curl', '二头弯举链', '手臂', '肘屈', ['db-curl', 'ez-bar-curl', 'preacher-curl', 'cable-curl', 'incline-db-curl']),
  'cable-curl': chain('biceps-curl', '二头弯举链', '手臂', '肘屈', ['db-curl', 'ez-bar-curl', 'preacher-curl', 'cable-curl', 'incline-db-curl']),
  'incline-db-curl': chain('biceps-curl', '二头弯举链', '手臂', '肘屈', ['db-curl', 'ez-bar-curl', 'preacher-curl', 'cable-curl', 'incline-db-curl']),
  'hammer-curl': chain('hammer-curl', '锤式弯举链', '手臂', '肘屈', ['hammer-curl', 'rope-hammer-curl']),
  'rope-hammer-curl': chain('hammer-curl', '锤式弯举链', '手臂', '肘屈', ['hammer-curl', 'rope-hammer-curl']),
  'triceps-pushdown': chain('triceps-extension', '三头伸展链', '手臂', '肘伸', ['triceps-pushdown', 'straight-bar-pushdown', 'overhead-cable-triceps-extension', 'skull-crusher']),
  'straight-bar-pushdown': chain('triceps-extension', '三头伸展链', '手臂', '肘伸', ['triceps-pushdown', 'straight-bar-pushdown', 'overhead-cable-triceps-extension', 'skull-crusher']),
  'overhead-cable-triceps-extension': chain('triceps-extension', '三头伸展链', '手臂', '肘伸', ['triceps-pushdown', 'straight-bar-pushdown', 'overhead-cable-triceps-extension', 'skull-crusher']),
  'skull-crusher': chain('triceps-extension', '三头伸展链', '手臂', '肘伸', ['triceps-pushdown', 'straight-bar-pushdown', 'overhead-cable-triceps-extension', 'skull-crusher']),
};
...
export const EXERCISE_KNOWLEDGE_OVERRIDES: Record<string, Record<string, unknown>> = {
  ...
  'incline-db-press': {
    ...
    alternativePriorities: {
      'smith-incline-press': 'priority',
      'machine-incline-chest-press': 'priority',
      'machine-chest-press': 'acceptable',
  ...
  'smith-incline-press': {
    canonicalExerciseId: 'smith-incline-press',
    kind: 'machine',
    movementPattern: '上斜推',
    primaryMuscles: ['胸'],
    secondaryMuscles: ['肩', '手臂'],
  ...
  'machine-incline-chest-press': {
    canonicalExerciseId: 'machine-incline-chest-press',
    kind: 'machine',
    movementPattern: '上斜推',
    primaryMuscles: ['胸'],
    secondaryMuscles: ['肩', '手臂'],
    muscleContribution: { 胸: 1, 肩: 0.45, 手臂: 0.35 },
    fatigueCost: 'medium',
    skillDemand: 'low',
    orderPriority: 3,
    equivalenceChainId: 'incline-press',
  ...
  'cable-fly': {
    ...
    orderPriority: 6,
    goalBias: ['肌肥大'],
    canonicalExerciseId: 'cable-fly',
    kind: 'isolation',
    equivalenceChainId: 'fly',
    alternativeIds: ['pec-deck-fly', 'db-fly', 'machine-chest-press', 'assisted-dip'],
    alternativePriorities: {
      'pec-deck-fly': 'priority',
      'db-fly': 'acceptable',
      'machine-chest-press': 'equipment_fallback',
      'assisted-dip': 'compound_fallback',
    },
  },
  'pec-deck-fly': {
    canonicalExerciseId: 'pec-deck-fly',
    kind: 'machine',
    movementPattern: '飞鸟',
    primaryMuscles: ['胸'],
    secondaryMuscles: [],
  ...
  'lateral-raise': {
    canonicalExerciseId: 'lateral-raise',
    kind: 'isolation',
    movementPattern: '肩外展',
    primaryMuscles: ['肩'],
    secondaryMuscles: [],
    ...
    alternativePriorities: {
      'cable-lateral-raise': 'priority',
      'machine-lateral-raise': 'priority',
      'rear-delt-raise': 'not_recommended',
      'shoulder-press': 'not_recommended',
    },
    recommendedLoadRange: '约 40%-65% 1RM',
  },
  'triceps-pushdown': {
    canonicalExerciseId: 'triceps-pushdown',
    kind: 'isolation',
    movementPattern: '肘伸',
    primaryMuscles: ['手臂'],
    secondaryMuscles: [],
    ...
    alternativePriorities: {
      'straight-bar-pushdown': 'priority',
      'overhead-cable-triceps-extension': 'acceptable',
      'skull-crusher': 'optional',
      'close-grip-bench': 'compound_fallback',
      'assisted-dip': 'compound_fallback',
      'bench-press': 'not_recommended',
      'shoulder-press': 'not_recommended',
      'cable-fly': 'not_recommended',
    },
  },
  ...
  'rear-delt-raise': {
    canonicalExerciseId: 'rear-delt-raise',
    kind: 'isolation',
    movementPattern: '后束飞鸟',
    primaryMuscles: ['肩'],
    secondaryMuscles: ['背'],
  ...
  'db-curl': {
    ...
    alternativePriorities: {
      'ez-bar-curl': 'priority',
      'preacher-curl': 'priority',
      'cable-curl': 'priority',
      'incline-db-curl': 'acceptable',
      'hammer-curl': 'optional',
    },
  },
  'hammer-curl': {
    canonicalExerciseId: 'hammer-curl',
    kind: 'isolation',
    movementPattern: '肘屈',
    primaryMuscles: ['手臂'],
    secondaryMuscles: [],
    ...
    alternativePriorities: {
      'rope-hammer-curl': 'priority',
      'db-curl': 'acceptable',
      'ez-bar-curl': 'optional',
    },
  },
  'ez-bar-curl': {
    canonicalExerciseId: 'ez-bar-curl',
    kind: 'isolation',
    movementPattern: '肘屈',
    primaryMuscles: ['手臂'],
    secondaryMuscles: [],
  ...
  'cable-curl': {
    canonicalExerciseId: 'cable-curl',
    kind: 'isolation',
    movementPattern: '肘屈',
    primaryMuscles: ['手臂'],
    secondaryMuscles: [],
  ...
  'incline-db-curl': {
    canonicalExerciseId: 'incline-db-curl',
    kind: 'isolation',
    movementPattern: '肘屈',
    primaryMuscles: ['手臂'],
    secondaryMuscles: [],
  ...
  'rope-hammer-curl': {
    canonicalExerciseId: 'rope-hammer-curl',
    kind: 'isolation',
    movementPattern: '肘屈',
    primaryMuscles: ['手臂'],
    secondaryMuscles: [],
  ...
  'shoulder-press': {
    ...
    alternativePriorities: {
      'machine-shoulder-press': 'priority',
      'smith-shoulder-press': 'priority',
      'landmine-press': 'acceptable',
      'db-bench-press': 'optional',
      'lateral-raise': 'not_recommended',
      'triceps-pushdown': 'not_recommended',
      'cable-fly': 'not_recommended',
    },
  ...
  'machine-shoulder-press': {
    canonicalExerciseId: 'machine-shoulder-press',
    kind: 'machine',
    movementPattern: '垂直推',
    primaryMuscles: ['肩'],
    secondaryMuscles: ['手臂', '胸'],
    muscleContribution: { 肩: 1, 手臂: 0.4, 胸: 0.15 },
    fatigueCost: 'medium',
    skillDemand: 'low',
    orderPriority: 3,
    equivalenceChainId: 'vertical-press',
  ...
  'smith-shoulder-press': {
    canonicalExerciseId: 'smith-shoulder-press',
    kind: 'machine',
    movementPattern: '垂直推',
    primaryMuscles: ['肩'],
    secondaryMuscles: ['手臂', '胸'],
    muscleContribution: { 肩: 1, 手臂: 0.45, 胸: 0.15 },
    fatigueCost: 'high',
    skillDemand: 'medium',
    orderPriority: 2,
    equivalenceChainId: 'vertical-press',
    regressionIds: ['machine-shoulder-press'],
    progressionIds: ['shoulder-press'],
    contraindications: ['overhead_press_restriction', 'scapular_control'],
  },
  'cable-lateral-raise': {
    canonicalExerciseId: 'cable-lateral-raise',
    kind: 'isolation',
    movementPattern: '肩外展',
    primaryMuscles: ['肩'],
    secondaryMuscles: [],
  ...
  'machine-lateral-raise': {
    canonicalExerciseId: 'machine-lateral-raise',
    kind: 'machine',
    movementPattern: '肩外展',
    primaryMuscles: ['肩'],
    secondaryMuscles: [],
  ...
  'close-grip-bench': {
    canonicalExerciseId: 'close-grip-bench',
    kind: 'compound',
    movementPattern: '水平推',
    primaryMuscles: ['手臂'],
  ...
  'preacher-curl': {
    canonicalExerciseId: 'preacher-curl',
    kind: 'isolation',
    movementPattern: '肘屈',
    primaryMuscles: ['手臂'],
    secondaryMuscles: [],
  ...
  'straight-bar-pushdown': {
    canonicalExerciseId: 'straight-bar-pushdown',
    kind: 'isolation',
    movementPattern: '肘伸',
    primaryMuscles: ['手臂'],
    secondaryMuscles: [],
  ...
  'overhead-cable-triceps-extension': {
    canonicalExerciseId: 'overhead-cable-triceps-extension',
    kind: 'isolation',
    movementPattern: '肘伸',
    primaryMuscles: ['手臂'],
    secondaryMuscles: ['肩'],
    muscleContribution: { 手臂: 1, 肩: 0.15 },
    fatigueCost: 'medium',
    skillDemand: 'medium',
    orderPriority: 7,
    goalBias: ['肌肥大'],
  ...
  'skull-crusher': {
    canonicalExerciseId: 'skull-crusher',
    kind: 'isolation',
    movementPattern: '肘伸',
    primaryMuscles: ['手臂'],
    secondaryMuscles: [],
  ...
  'assisted-dip': {
    ...
    primaryMuscles: ['胸'],
    secondaryMuscles: ['手臂', '肩'],
    muscleContribution: { 胸: 1, 手臂: 0.6, 肩: 0.3 },
    fatigueCost: 'high',
    skillDemand: 'medium',
    orderPriority: 3,
    equivalenceChainId: 'horizontal-press',
    contraindications: ['shoulder_extension_restriction', 'scapular_control'],
  },
  'db-bench-press': {
    movementPattern: '水平推',
    primaryMuscles: ['胸'],
  ...
  'landmine-press': {
    canonicalExerciseId: 'landmine-press',
    kind: 'compound',
    movementPattern: '斜向推',
    primaryMuscles: ['肩'],
