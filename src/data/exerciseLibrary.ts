...
export const EXERCISE_EQUIVALENCE_CHAINS: Record<string, ExerciseEquivalenceChain> = {
  ...
  'face-pull': chain('rear-delt-scapular', '后束肩胛控制链', '肩', '肩胛控制', ['face-pull', 'reverse-pec-deck', 'cable-rear-delt-fly', 'rear-delt-raise']),
  'reverse-pec-deck': chain('rear-delt-scapular', '后束肩胛控制链', '肩', '后束飞鸟', ['face-pull', 'reverse-pec-deck', 'cable-rear-delt-fly', 'rear-delt-raise']),
  'cable-rear-delt-fly': chain('rear-delt-scapular', '后束肩胛控制链', '肩', '后束飞鸟', ['face-pull', 'reverse-pec-deck', 'cable-rear-delt-fly', 'rear-delt-raise']),
  'rear-delt-raise': chain('rear-delt-scapular', '后束肩胛控制链', '肩', '后束飞鸟', ['face-pull', 'reverse-pec-deck', 'cable-rear-delt-fly', 'rear-delt-raise']),
