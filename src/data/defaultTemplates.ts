...
export const INITIAL_TEMPLATES: TrainingTemplate[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      makeExercise('hammer-curl', '锤式弯举', '锤弯', '手臂', 'isolation', 2, 10, 15, 75, 12.5, ['绳索锤式弯举']),
    ],
  },
  {
    id: 'legs-a',
    ...
    exercises: [
      ...
      makeExercise('leg-press', '腿举', '腿举', '腿', 'machine', 3, 10, 15, 120, 140, ['高脚杯深蹲']),
  ...
  },
  {
    ...
    exercises: [
      ...
      makeExercise('lateral-raise', '侧平举', '侧平举', '肩', 'isolation', 3, 12, 20, 60, 7.5, ['绳索侧平举']),
  ...
  },
  {
    ...
    focus: '下肢',
    duration: 70,
    note: '下肢综合模板，优先腿推和髋铰链。',
    exercises: [
      makeExercise('hack-squat', '哈克深蹲', '哈克', '腿', 'compound', 3, 6, 10, 150, 80, ['深蹲', '腿举']),
  ...
  },
  {
    ...
    exercises: [
      ...
      makeExercise('hammer-curl', '锤式弯举', '锤弯', '手臂', 'isolation', 3, 10, 15, 60, 12.5, ['绳索锤弯']),
      makeExercise('lateral-raise', '侧平举', '侧平举', '肩', 'isolation', 4, 12, 20, 60, 7.5, ['绳索侧平举']),
    ],
  },
  {
    id: 'quick-30',
    ...
    exercises: [
      ...
      makeExercise('hack-squat', '哈克深蹲', '哈克', '腿', 'compound', 2, 8, 12, 120, 80, ['腿举']),
      makeExercise('lateral-raise', '侧平举', '侧平举', '肩', 'isolation', 2, 12, 20, 45, 7.5, ['绳索侧平举']),
    ],
  },
  {
    id: 'crowded-gym',
    ...
    exercises: [
      ...
      makeExercise('leg-press', '腿举', '腿举', '腿', 'machine', 3, 10, 15, 90, 140, ['高脚杯深蹲']),
      ...
      makeExercise('hammer-curl', '绳索锤式弯举', '锤弯', '手臂', 'isolation', 2, 10, 15, 60, 15, ['哑铃弯举']),
    ],
  },
];
