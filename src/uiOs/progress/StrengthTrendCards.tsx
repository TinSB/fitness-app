  ...
  return (
    <section aria-label="Strength trend PR e1RM cards" className="space-y-3">
      <div className="flex items-end justify-between gap-3">
        <div>
          <p className="text-sm font-semibold text-slate-500">力量趋势 / PR / e1RM</p>
          <h3 className="text-lg font-bold text-slate-950">主要动作快速判断</h3>
        </div>
        <span className="text-xs font-semibold text-slate-400">只读现有计算</span>
      </div>
