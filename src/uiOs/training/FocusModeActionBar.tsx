...
export function FocusModeActionBar({
  ...
  return (
    <WorkoutActionBar className="border-white/10 bg-[#101012]/95 text-white shadow-[0_-18px_60px_rgba(0,0,0,0.35)] backdrop-blur-xl md:static">
      <div className="mx-auto grid w-full max-w-2xl gap-2" data-focus-mode-action-bar="one-dominant-primary">
        <FocusModeSecondaryActions actions={secondaryActions} />
        {summary ? (
