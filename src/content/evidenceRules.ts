...
export const EVIDENCE_RULES: EvidenceRule[] = [
  ...
  {
    id: 'health_data_readiness_support',
    title: '导入健康数据辅助准备度',
    label: '健康数据辅助准备度',
    practicalSummary: '睡眠、静息心率、HRV 和外部活动负荷可作为当天训练保守程度的辅助信号，但不能替代用户主观状态。',
    appliesTo: ['健康数据导入', '准备度', '恢复参考', '训练解释'],
    sourceIds: ['acsm_resistance_training_guidance', 'strength_programming_consensus'],
    authorityIds: ['acsm', 'nsca'],
    implementationType: 'product_heuristic',
    evidenceTier: 'C',
    confidence: 'moderate',
    caveat: '健康数据用于训练准备度辅助判断，不是医学诊断，也不应单独决定训练负荷；HealthKit/WorkoutKit 原生同步不属于 Web/PWA 当前能力。',
  },
  {
