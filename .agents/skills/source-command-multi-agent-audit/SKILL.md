---
name: "source-command-multi-agent-audit"
description: "严格的多 Agent 独立审计流程，覆盖根因 / 架构 / UI / 数据安全 / 推荐 / 回归 / 实施。"
---

# source-command-multi-agent-audit

Use this skill when the user asks to run the migrated source command `multi-agent-audit`.
...
- 如果当前 Codex 会话支持并行 subagent，**优先并行调起前 6 个 Agent**，等全部报告完成再调 Implementation Agent。
