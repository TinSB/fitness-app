...
describe('History data-flag hardening browser boundary', () => {
  it('keeps the exact two-route browser mutation allowlist', () => {
  ...
  it('keeps package scripts and dependencies unchanged for mutation scope', () => {
