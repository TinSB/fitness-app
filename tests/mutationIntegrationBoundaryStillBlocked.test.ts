...
describe('mutation integration remains blocked in browser runtime', () => {
  ...
  it('does not add frontend mutation client files, mutation feature flag wiring, or API-backed localStorage', () => {
  ...
  it('keeps package scripts and dependencies away from mutation integration routes', () => {
  ...
  it('keeps docs from giving action-oriented mutation instructions', () => {
    const docs = [
