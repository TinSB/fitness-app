...
describe('deployment environment secrets boundary still blocked', () => {
  it('keeps browser runtime free of deployment/auth/sync/server modules and forbidden routes', () => {
  ...
  it('keeps package files, deployment config, and schema unchanged in scope', () => {
