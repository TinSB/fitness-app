...
describe('production sync conflict boundary', () => {
  it('keeps runtime free of network cloud queue worker and blocked routes', () => {
  ...
  it('keeps conflict detector pure and local', () => {
