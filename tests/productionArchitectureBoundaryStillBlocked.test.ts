...
describe('production architecture boundary still blocked', () => {
  it('keeps App.tsx free of production backend/auth/sync/deployment wiring', () => {
    const app = readSource('src/App.tsx');
    expect(app).not.toMatch(/PRODUCTION_BACKEND_AUTH_SYNC_DEPLOYMENT|auth provider|login|signup|cloud sync|deployment|sentry/i);
  });
