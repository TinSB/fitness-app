...
describe('cloud sync conflict boundary still blocked', () => {
  it('keeps browser runtime free of sync/cloud/auth/deployment modules and forbidden routes', () => {
  ...
  it('keeps package files and sync/schema runtime unchanged in scope', () => {
