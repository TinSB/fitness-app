...
describe('lowest-risk mutation planning keeps write paths blocked', () => {
  ...
  it('keeps package scripts and dependencies away from lowest-risk mutation implementation', () => {
  ...
  it('keeps docs from giving action-oriented lowest-risk implementation instructions', () => {
    const docs = [
    ...
    const blockedInstructions = [
      ...
      /implement DataHealth dismiss now/i,
