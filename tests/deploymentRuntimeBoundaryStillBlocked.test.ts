...
describe('deployment runtime boundary still blocked', () => {
  it('keeps browser runtime free of deployment, secret, sync, auth, and forbidden routes', () => {
  ...
  it('keeps package free of deployment scripts or dependencies', () => {
