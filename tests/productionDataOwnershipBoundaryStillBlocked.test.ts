...
describe('production data ownership boundary still blocked', () => {
  it('keeps App.tsx free of production backend/auth/sync/deployment wiring', () => {
    const app = readSource('src/App.tsx');
    expect(app).not.toMatch(/PRODUCTION_DATA_OWNERSHIP|auth provider|login|signup|cloud sync|deployment|sentry/i);
  });
