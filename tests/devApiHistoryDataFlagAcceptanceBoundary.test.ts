...
describe('History data-flag acceptance browser boundary', () => {
  it('keeps browser mutation route allowlist exactly to DataHealth dismiss and History data-flag', () => {
  ...
  it('does not add package scripts, dependencies, or browser automation dependencies', () => {
  ...
  it('keeps existing dist output free of Node-only tokens when dist is present', () => {
