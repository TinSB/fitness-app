...
describe('production security privacy boundary', () => {
  it('keeps runtime free of new production auth sync deployment and blocked routes', () => {
  ...
  it('keeps route allowlist and localStorage default unchanged', () => {
