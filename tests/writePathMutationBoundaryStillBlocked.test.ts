...
describe('write-path mutation integration remains blocked', () => {
  ...
  it('keeps package scripts and dependencies away from write-path integration', () => {
  ...
  it('keeps docs from giving action-oriented write-path instructions', () => {
    const docs = [
