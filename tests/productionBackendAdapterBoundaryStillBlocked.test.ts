...
describe('production backend adapter boundary still blocked', () => {
  it('keeps browser runtime free of production backend adapter and forbidden routes', () => {
  ...
  it('keeps package files and production schema unchanged in scope', () => {
