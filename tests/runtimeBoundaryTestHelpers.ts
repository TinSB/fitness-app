...
const runtimeFilesWithDedicatedBoundaryCoverage = new Set([
  ...
  'src/cloudProduction/productionFullAcceptanceRuntime.ts',
...
export const expectNoUnexpectedAppDiff = (diff: string) => {
  ...
  expect(
    isTrainingViewCompletionDiff || isSupportCompletionDiff || isCoachAutomationPipelineRewireDiff,
  ).toBe(true);
