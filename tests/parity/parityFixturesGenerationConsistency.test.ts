...
describe('parityFixturesGenerationConsistency', () => {
  ...
  it('parityFixturesGenerationConsistency --check passes without drift', () => {
    ...
    // Summary line: "checked 74 fixture(s); 0 changed" (5 iOS-0 + 9 iOS-4B0
    ...
    // 1 AN-6 intelligence-summary + 1 AN-8 sort-stability tie parity fixtures).
    expect(result.stdout).toMatch(/checked\s+74\s+fixture/);
