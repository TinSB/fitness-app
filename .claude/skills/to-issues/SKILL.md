...
## Clean rewrite guard
- Issues for implementation must be rewrite slices with target behavior, inputs, outputs, fixtures, validation, and reuse decision.
- Do not create tasks that simply patch legacy runtime unless explicitly approved.
- External website paid-intent validation tasks are separate from clean iOS runtime tasks.
