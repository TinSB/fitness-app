...
## Clean rewrite guard
- Diagnose legacy `ios/` issues as reference-only unless an approved rewrite slice makes that code in scope.
- Living docs define target behavior; old runtime behavior does not override them.
- External website / paid-intent validation is outside this repo runtime.
