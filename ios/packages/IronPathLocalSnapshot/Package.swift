...
// SwiftData, or IronPathDomain AppData.

import PackageDescription

let package = Package(
    name: "IronPathLocalSnapshot",
    platforms: [.iOS(.v17)],
    products: [
        .library(name: "IronPathLocalSnapshot", targets: ["IronPathLocalSnapshot"]),
    ],
    targets: [
        .target(name: "IronPathLocalSnapshot"),
        .testTarget(
            name: "IronPathLocalSnapshotTests",
            dependencies: ["IronPathLocalSnapshot"]
        ),
    ]
)
