...
//
// PURE mapping: native canonical `IronPathDomain.TrainingSession`s (from
...
public enum HealthKitWorkoutExporter {
    /// The `HKWorkout` metadata key holding the IronPath canonical session id — the
    ...
    /// IronPath native sessions are strength training; every exported workout uses this
