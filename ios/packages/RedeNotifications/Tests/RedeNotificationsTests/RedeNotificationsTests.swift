// RedeNotificationsTests — N-1 Local Rest-Timer Notification V1.
//
...
final class RedeNotificationsTests: XCTestCase {

    /// Deterministic reference instant (never the wall clock).
    private let now = Date(timeIntervalSince1970: 1_700_000_000)

    func testVersionProbeIsBootstrapConstant() {
        XCTAssertEqual(RedeNotificationsVersion.value, "0.0.1-bootstrap")
    }
