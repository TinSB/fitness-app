...
//     `IronPathTrainingDecision.ExerciseLibrary.formatExerciseDisplayName`. NOT
...
//     `IronPathTrainingDecision.VolumeAdaptationEngine.formatMuscleName`. NOT here.
...
//   IronPathDomain dependency to IronPathL10n/Package.swift — forbidden by the
...
//   IronPathTrainingDecision and legitimately depends on both packages) adapts its
...
public enum Formatters {
    ...
    /// so IronPathL10n stays self-contained.
