...
// companion to the Today read path (`RedeTrainingDecision.resolveTodayReadinessState`),
...
// derived latest body weight live in the pure `RedeDomain.ProfileDisplayData`
