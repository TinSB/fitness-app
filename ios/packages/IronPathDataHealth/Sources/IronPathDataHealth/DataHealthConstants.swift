...
public enum DataHealthConstants {
    ...
    /// are considered stale for the readiness pipeline. TS:
    ...
    /// values. Anything above this is hard-capped. TS:
    ...
    /// pain triggers + restricted exercises are empty. TS:
    ...
    /// unusable. TS: `DATA_HEALTH_FALLBACK_DURATION_MIN`.
    ...
    /// TS: `DATA_HEALTH_LEDGER_MAX_ENTRIES`.
    ...
    /// hours, a re-run is treated as no-op. TS:
