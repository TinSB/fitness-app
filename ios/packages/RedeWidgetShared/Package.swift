...
// RedeWidgetShared — W-1 Readiness Widget V1.
//
...
// plain Strings, so the package needs no RedeDomain / TrainingDecision edge
// (master §6.3). See docs/ios-native-migration/IOS_W1_READINESS_WIDGET_V1.md.

import PackageDescription

let package = Package(
    name: "RedeWidgetShared",
    platforms: [.iOS(.v17)],
    products: [
        .library(name: "RedeWidgetShared", targets: ["RedeWidgetShared"]),
    ],
    targets: [
        .target(
            name: "RedeWidgetShared"
        ...
        .testTarget(
            name: "RedeWidgetSharedTests",
            dependencies: ["RedeWidgetShared"]
        ),
    ]
)
