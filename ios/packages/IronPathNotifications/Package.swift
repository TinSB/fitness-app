...
// IronPathNotifications — N-1 Local Rest-Timer Notification V1.
//
...
// seconds, so the package stays decoupled from IronPathDomain / TrainingDecision
...
let package = Package(
    name: "IronPathNotifications",
    platforms: [.iOS(.v17)],
    products: [
        .library(name: "IronPathNotifications", targets: ["IronPathNotifications"]),
    ],
    targets: [
        .target(
            name: "IronPathNotifications"
        ...
        .testTarget(
            name: "IronPathNotificationsTests",
            dependencies: ["IronPathNotifications"]
        ),
    ]
)
