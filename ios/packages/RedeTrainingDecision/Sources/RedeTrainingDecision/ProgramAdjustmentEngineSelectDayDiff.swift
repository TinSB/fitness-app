...
//   * PA-S1 RedeDomain types verbatim (ProgramTemplate(+PARich) / DayTemplate /
...
// Swift port of these two lives in `RedeL10n.Formatters` (PA-S4). RedeL10n is a
// SEPARATE leaf package that RedeTrainingDecision does NOT depend on — and the repo's
...
// {RedeDomain, RedeDataHealth}. Adding an IPTD -> RedeL10n edge would break
...
extension ProgramAdjustmentEngine {
    ...
    // IPTD -> RedeL10n edge, to respect the package-graph dependency contract. The
