...
// duplicate rows). The merge keeps the packages decoupled: `RedeDomain` /
// `RedeDataHealth` never import `RedeLocalSnapshot`; only this app-layer
...
final class HistoryRealDataModel: ObservableObject {
    ...
    /// to a NEUTRAL `SupplementalNativeCompletion` (no `RedeLocalSnapshot` type
